...
public class PurchaseOrder implements Serializable {
    ...
    public boolean isQualityCertificateRequired() {
        return qualityCertificateRequired;
    }

    public void setQualityCertificateRequired(boolean qualityCertificateRequired) {
        this.qualityCertificateRequired = qualityCertificateRequired;
    }
    ...
    public boolean isUrgent() {
        return "Urgent".equals(priority) || "Critical".equals(priority);
    }
